...
function LanguageAndEduaction() {
  return (
    <section className="bg-white flex flex-col gap-10 items-center w-full">
      <h1 className="text-7xl font-bold ">Idiomas y Educación</h1>
      <p className="text-3xl">
        Mi información académica en el habito profecional
      </p>

      <article className="flex gap-10 bg-white w-full p-10 ">
        <div className="w-1/2 bg-white p-4 shadow-inner shadow-black rounded-xl">
